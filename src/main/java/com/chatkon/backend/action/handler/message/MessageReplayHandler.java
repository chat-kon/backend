...
import com.chatkon.backend.model.dto.message.MessageReplayRequestDto;
...
public class MessageReplayHandler implements ActionHandler<MessageReplayRequestDto> {
    private final MessageService messageService;
    private final PublicChatService publicChatService;

    @Override
    public ActionType type() {
        return ActionType.REPLAY_MESSAGE;
    }

    @Override
    public ActionResult handle(Long userId, MessageReplayRequestDto dto) {
        // TODO implement it
        ...
        MessageReplayResponseDto responseDto = MessageReplayResponseDto.builder()
                .build();

        Action action = Action.builder()
                .dto(responseDto)
                .type(ActionType.REPLAY_MESSAGE)
                .build();
